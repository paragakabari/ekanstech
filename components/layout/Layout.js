...
export default function Layout({
  ...
  return (
    <>
      ...
      <div onClick={() => setChatBoat(!chatBoat)}>
        <img
          src="assets/img/Cute_chat_bot.png"
          className="chatBoatIcon"
          style={{ bottom: scroll ? undefined : "40px" }}
          alt=""
        />
      </div>

      {chatBoat ? (
        <div style={{ transition: "all 0.5s" }} className="chatboxOuter">
          {/* Close Button */}
